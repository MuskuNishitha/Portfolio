  ...
  return (
    <ThemeContext.Provider value={value}>
      ...
      <div className="fixed top-24 right-6 z-50 flex flex-col gap-2">
        ...
        <button
          onClick={toggleTheme}
          className="w-12 h-12 rounded-full backdrop-blur-xl flex items-center justify-center transition-all duration-300 hover:scale-110 hover:rotate-12 shadow-lg"
          style={{
