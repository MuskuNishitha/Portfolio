        ...
        if (!cancelled) {
          ...
          if (data && typeof data === 'object') {
            setContent({
              ...
              profileImageUrl: data.profileImageUrl || defaultContent.profileImageUrl,
              resumeUrl: data.resumeUrl || defaultContent.resumeUrl,
              techStack: Array.isArray(data.techStack) && data.techStack.length ? data.techStack : defaultContent.techStack,
              socials: {
                linkedin: data.socials?.linkedin || defaultContent.socials.linkedin,
        ...
        <div className="container-custom relative z-10 px-4 sm:px-6 lg:px-8">
          <div className="flex justify-center items-center min-h-[400px]">
            <div className="text-center">
              ...
              <p className="mt-4" style={{ color: 'var(--text-muted)' }}>Loading portfolio...</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="container-custom relative z-10 px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 md:gap-[60px] items-center">
          ...
          <div className="text-center lg:text-left order-2 lg:order-1">
            ...
            >
              {content.summary || "Full-Stack Developer specializing in MERN stack with 2+ years of experience."}
            </p>
